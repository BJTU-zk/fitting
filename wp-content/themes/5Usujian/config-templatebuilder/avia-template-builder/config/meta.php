...
$boxes = array(
	...
	array( 'title' =>__('短代码分析器','avia_framework' ), 'id'=>'avia_sc_parser', 'page'=>array('post','portfolio','page','product'), 'context'=>'normal', 'priority'=>'high', 'expandable'=>false ),
...
$elements = array(
	...
	array(
		"slug"          => "avia_sc_parser",
        "name"          => __("短代码分析器窗口", 'avia_framework' ),
        "id"            => "sc_parser_info",
