			...
			<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo $itemValue; echo implode(' ', $classes ); ?>">
				<dl class="menu-item-bar">
					<dt class="menu-item-handle">
						...
						<span class="item-controls">
							...
							<span class="item-type item-type-avia"><?php _e('菜单列'); ?></span>
							<span class="item-type item-type-megafied"><?php _e('(巨型菜单)'); ?></span>
				...
				<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
					...
					<p class="description description-thin description-label avia_label_desc_on_active">
						...
						<span class='avia_mega_label'><?php _e( '巨型菜单列标题 <span class="avia_supersmall">(如果不想显示标题请输入: "-" )</span>' ); ?></span>
					...
					<p class="field-link-target description description-thin">
						<label for="edit-menu-item-target-<?php echo $item_id; ?>">
							...
							<select id="edit-menu-item-target-<?php echo $item_id; ?>" class="widefat edit-menu-item-target" name="menu-item-target[<?php echo $item_id; ?>]">
								<option value="" <?php selected( $item->target, ''); ?>><?php _e('当前窗口或选项卡'); ?></option>
								<option value="_blank" <?php selected( $item->target, '_blank'); ?>><?php _e('新窗口或选项卡'); ?></option>
							</select>
						</label>
					</p>
					...
					<!-- ################# avia custom code here ################# -->
						...
						<?php
						$title = '输入一段文本来描述菜单项，此文本不能带链接。（请注意：菜单标题不能为空，否则WordPress将会删除此菜单项）';
					...
					<div class="menu-item-actions description-wide submitbox">
						...
						echo wp_nonce_url(
							...
							?>#menu-item-settings-<?php echo $item_id; ?>">取消</a>
					</div>
