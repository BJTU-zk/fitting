...
if(!current_theme_supports('avia_disable_import_export')){
	...
	$avia_pages[] = array( 'slug' => 'themekey', 	'parent'=>'avia', 'icon'=>"new/window-up-7@3x.png", 'title' => __('主题密钥', 'avia_framework'));
	$avia_pages[] = array( 'slug' => 'demo', 		'parent'=>'avia', 'icon'=>"new/window-up-7@3x.png", 'title' => __('安装数据', 'avia_framework'));
						...
						<div class='avprev-layout-container-inner'>
							<div class='avprev-layout-header'>
								<div class='avprev-layout-container-sizer'>
									<strong class='avprev-layout-menu-description'>Logo + 主菜单区域</strong>
									<div class='avprev-layout-menu'>
									<span class='avprev-layout-menuitem avprev-layout-menuitem-first'>首页</span> 
									<span class='avprev-layout-divider'>|</span> 
									<span class='avprev-layout-menuitem'>关于</span> 
									<span class='avprev-layout-divider'>|</span> 
									<span class='avprev-layout-menuitem'>联系</span> 
									</div>
								</div>
							...
							<div class='avprev-layout-content-container'>
								<div class='avprev-layout-slider'>
									<strong>全宽(100%宽度)区域 (如全宽幻灯片)</strong>
								</div>
							
								<div class='avprev-layout-container-sizer'>
									<div class='avprev-layout-content av-cell'><strong>内容区域</strong><p>这里是内容区域，可以包含网站所有的博客列表、单页面、产品展示等等。</p></div>
									<div class='avprev-layout-sidebar av-cell'><strong>侧边栏</strong><p>这里放置网站所有的侧边栏小工具。</p>
									</div>
								</div>
							</div>
...
$avia_elements[] =	array(
					...
					"additions" => array('不显示小工具' => "", /* 'Display Widgets by page logic' => "av-auto-widget-logic", */ '显示指定小工具'=> '%result%'),
					);
...
$avia_elements[] =	array(
					...
					<!--<small class='text_small_outside'>Next Event: in 10 hours 5 minutes.</small>-->
						...
						<div class='live-header_color border'>
							<h3 class='heading webfont_google_webfont'>头部Logo区域</h3>
							<span class='text'>活动菜单项 | </span>
							<span class='meta'>无效菜单项</span><br/>
							<a class='a_link' href='#'>自定义文本链接</a>
							<a class='an_activelink' href='#'>鼠标悬停时</a>
							<div class='bg2'>强调区域背景 + 边框颜色</div>
						</div>
						...
						<div class='live-main_color border avia_half'>
							<h3 class='webfont_google_webfont main_h3 heading'>主体内容标题</h3>
								<p class='content_p'>这里是默认内容标题，字体颜色、标题以及链接颜色可以在下面设置。 <br/>
									<a class='a_link' href='#'>链接</a>
									<a class='an_activelink' href='#'>鼠标悬停时的链接</a>
									<span class='meta'>次要内容字体</span>
						...
						<div class='live-alternate_color border avia_half avia_half_2'>
								<h3 class='webfont_google_webfont main_h3 heading'>交互内容区域</h3>
								<p>这里是交互内容标题，字体颜色、标题以及链接颜色可以在下面设置。 <br/>
									<a class='a_link' href='#'>链接</a>
									<a class='an_activelink' href='#'>鼠标悬停时的链接</a>
									<span class='meta'>次要内容字体</span>
						...
						<div class='live-footer_color border'>
							<h3 class='webfont_google_webfont heading'>底部标题</h3>
							<p>这里是底部背景上的字体。</p>
							<a class='a_link' href='#'>链接1 | 链接2</a>
							<span class='meta'> | 次要内容字体</span>

						</div>

						<div class='live-socket_color border'>版权文本 <a class='a_link' href='#'>链接1 | 链接2</a>
							<span class='meta'> | 次要内容字体</span>
...
foreach($colorsets as $set_key => $set_value)
{
	...
	$avia_elements[] = array(
						...
						//5Usujian
						"desc" 	=> $set_value.__("The background image of your", 'avia_framework')."<br/>",
						"type" 	=> "select",
					...
					<div id='pr-stretch-wrap' >
						...
						<div id='pr-header-style-wrap' >
							<div id='pr-phone-wrap' >
								<div id='pr-social-wrap' >
									<div id='pr-seconary-menu-wrap' >
										<div id='pr-menu-2nd'>{$iconSpan}<span class='pr-secondary-items'>登录 | 注册 | 其它</span><span class='pr-phone-items'>Phone: 555-4432</span></div>
										<div id='avia_header_preview' >
											<div id='pr-main-area' >
												...
												<span id='pr-menu-inner'><span class='pr-menu-single pr-menu-single-first'>主页</span><span class='pr-menu-single'>关于</span><span class='pr-menu-single'>联系</span></span> <img id='search_icon' src='".AVIA_IMG_URL."icons/search.png' alt='' />
												<div id='pr-burger-menu'>
													<span class='burger-top'></span>
													<span class='burger-mid'></span>
													<span class='burger-low'></span>
						...
						<div id='pr-breadcrumb'>某个标题 <span class='some-breadcrumb'>主页  &#187; 管理  &#187; 头部 </span></div>
						<div id='pr-content-area'> 内容 / 幻灯片 / 其它 
						<div class='inner-content'>无忧速建网致力于网站快速开发，提供专业网站源码下载服务，所有源码经严格测试，解压上传即可用，可维护性、SEO亲和性强。又有独家出品的建站教程，真正手把手、零基础建站，不懂编程也能当站长！本站还提供丰富的实用性强的特效插件，秉承易用、高效、交互性强的原则，让建站更加轻而易举。</div>
						</div>
						</div>
					</div>
					",
...
$avia_elements[] =	array(
					"slug"	=> "demo",
					"name" 	=> __("点击图片开始导入吧！", 'avia_framework'),
					"desc" 	=> 	 "<p><strong>{$what_get} <a href='http://5usujian.com' target='_blank'>{$online_demo}</a></strong></p>"
								...
								."</ul>",
					'files' => "/includes/admin/demo_files/demo",
					"id" 	=> "import",
					"type" 	=> "import",
					"image"	=> "includes/admin/demo_files/demo_images/demo.jpg"
					);
...
// 主题升级密钥代码开始
$avia_elements[] =	array(	
					"name" => __("输入主题升级密钥", 'avia_framework'),
					"desc" => __("输入并验证密钥后可以永久免费升级。输入完毕后请先点击验证密钥，验证成功后点击右下角的“保存所有”按钮即可完成,当有新版本发布时会在本页面顶部显示通知", 'avia_framework'),
					"id" => "widgetdescription",
					"std" => "",
					"slug"	=> "themekey",
					"type" => "heading",
...
$avia_elements[] =	array(
					"slug"	=> "themekey",
					"name" 	=> __("淘宝账号", 'avia_framework'),
					"desc" 	=> __("请输入购买源码时所用的的淘宝账号", 'avia_framework'),
					"id" 	=> "alipayid",
					"type" 	=> "text",
					"std" 	=> ""
					);
...
$avia_elements[] =	array(
					"slug"	=> "themekey",
					"name" 	=> __("主题密钥", 'avia_framework'),
					"desc" 	=> __("请输入随源码发送的主题密钥", 'avia_framework'),
					"id" 	=> "themekey",
					"type" 	=> "text",
					"std" 	=> ""
					);
$avia_elements[] = array(		
					"desc" => "<button class='avia_button' id='check-themekey'>验证密钥</button>",
					"std" => "",
					"slug"	=> "themekey",
					"type" => "heading",
					"nodescription"=>true);
